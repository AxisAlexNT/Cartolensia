...
var runtimeSettings = struct {
	...
	"gps.hide_large_track_jumps":                        true,
	"gps.track_jump_threshold_m":                        10000,
...
func runtimeSettingsSchema() []map[string]any {
	return []map[string]any{
		...
		{"tab": "gps", "key": "gps.hide_large_track_jumps", "type": "boolean", "label": "Hide large GPS jumps", "help": "Break visualized tracks at implausible GPS jumps. Original track points remain unchanged."},
		{"tab": "gps", "key": "gps.track_jump_threshold_m", "type": "number", "label": "GPS jump threshold (m)", "help": "Consecutive points farther apart than this are hidden in visualizations when jump hiding is enabled. Default 10000 m."},
